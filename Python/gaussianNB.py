...
from matplotlib.pylab import scatter,figure, clf, plot, xlabel, ylabel, xlim, ylim, title, grid, axes, show,semilogx, semilogy
...
y_pred = gnb.predict([[1.174598,-0.20]])
print(y_pred)

y_pred = gnb.predict([[0.885,-1.463]])
print(y_pred)

y_pred = gnb.predict([[-0.199,0.662]])
print(y_pred)
